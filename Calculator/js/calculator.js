...
const Calculator = {
    ...
    First_Operand: null,
    //This check wether or not the second operand has been input
    Wait_Second_Operand: false,
    //This will hold the operator
    operator: null
};

//This modifies teh values each time a button is clicked on
...
function Input_Decimal(dot) {
    //This ensures that accidental clicking on the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    //then udpates the operator and exits from the function.
...
function Calculator_Reset() { //set the values of the Calculator back to the initial values
...
function Update_Display() {
    //Makes us of the calculator-screen class to target the input tag
    //in the HTML element
